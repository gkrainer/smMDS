...
outpath = './Output_results/'
# json files location (use glob!)
settingsfn = './HSA_20pM_PBS_0p01tween_100ulph_400steps_2sec_27/*settings.json'
metadatafn = './HSA_20pM_PBS_0p01tween_100ulph_400steps_2sec_27/output/*Alldata_metadata.json'
